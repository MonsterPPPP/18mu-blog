...
const projects = defineCollection({
  ...
  schema: z.object({
    ...
    updated: z.date(), status: z.string(), published: z.boolean().default(false)
  })
});
...
const resume = defineCollection({ type: 'content', schema: z.object({ title: z.string(), titleEn: z.string(), updated: z.date() }) });
